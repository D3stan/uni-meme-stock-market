...
<section class="mb-6">
    ...
    <div class="space-y-3">
        ...
        <div class="notification-item bg-surface-200 rounded-xl p-3 border-l-4 border-brand" 
...
<section>
    ...
    <div class="space-y-3">
        ...
        <div class="notification-item bg-surface-50 rounded-xl p-3 opacity-70" 
             data-id="{{ $notification->id }}"
             data-read="true">
            <div class="flex items-start justify-between gap-2">
                <div class="flex-1 min-w-0">
...
<div class="flex flex-col items-center justify-center h-64 text-center">
    <span class="material-icons text-6xl text-surface-300 mb-4">notifications_none</span>
