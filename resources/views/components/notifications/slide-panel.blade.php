...
<aside id="notification-panel"
       class="fixed top-0 right-0 h-full w-[85%] max-w-[320px] lg:max-w-[360px] bg-surface-100 z-[70] transform translate-x-full transition-transform duration-300 ease-out shadow-2xl"
       role="dialog"
       aria-modal="true"
    ...
    {{-- Header --}}
    <header class="h-16 px-4 flex items-center justify-between border-b border-surface-200 bg-surface-100">
        <div>
    ...
    <div id="notification-content" class="overflow-y-auto h-[calc(100%-120px)] p-4">
        {{-- Loading state --}}
...
<div id="notification-detail-modal"
    ...
    <div class="relative bg-surface-100 rounded-2xl max-w-md w-[90%] max-h-[80vh] overflow-hidden shadow-2xl transform scale-95 transition-transform duration-200"
